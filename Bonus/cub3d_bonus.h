...
double			distanceBetweenPoints(double x1, double y1, double x2,
					double y2);
// draw a line
void			draw_line(mlx_image_t *img, double x1, double y1, double x2,
					double y2);
...
// ray_casting
void			draw_intersect(t_game *game, double ray_angle,
					double *ray_distance);
void			draw_intersect_door(t_game *game, double ray_angle,
					double *ray_distance);
double			get_vert_distance(t_game *game, double ray_angle,
					bool *foundVertHit, t_point *vert_intersect);
double			get_horz_distance(t_game *game, double ray_angle,
					bool *foundHorzHit, t_point *horz_intersect);
double			get_horz_door_distance(t_game *game, double ray_angle,
					bool *foundHorzHit, t_point *horz_intersect);
double			get_vert_door_distance(t_game *game, double ray_angle,
					bool *foundHorzHit, t_point *horz_intersect);
